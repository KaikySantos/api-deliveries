...
const findeAllDeliveriesDeliveryman = new FindAllDeliveriesDeliverymanController();
...
routes.get("/deliveryman/deliveries", ensureAuthenticateDeliveryman, findeAllDeliveriesDeliveryman.handle);
